...
## Project Structure
    ...
    ├── the_wellness_instit_44147  # Django project configurations
...
1. Clone this repo and `cd the_wellness_instit_44147`
...
2. Clone this repo and `cd the_wellness_instit_44147`
